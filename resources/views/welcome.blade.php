        ...
        <div class="card ">
            ...
            @csrf
               <div class="mb-3"> 
                ...
                <input type="text" class="form-control  @error("description") is-invalid @enderror mt-3" name="description" id="description" placeholder="Exemple A fox diving into the sea" autofocus  maxlength="1000">
                @error("description")
                <div  
